...
**Problem:** [1800D-Remove-Two-Letters](https://codeforces.com/contest/1800/problem/D)
...
The first line of input data contains a single integer t (1 ≤ t ≤ 10⁴) — number of test cases. 

The descriptions of the test cases follow.

The first line of the description of each test case contains an integer n (3 ≤ n ≤ 2 ⋅ 10⁵).
