...
**Problem:** [Cinema-Seat-Allocation](https://leetcode.com/problems/cinema-seat-allocation)
...
You are given a 2D integer array reservedSeats , where reservedSeats[i] = [row i , seat i ] means that seat seat i in row row i is already reserved.
