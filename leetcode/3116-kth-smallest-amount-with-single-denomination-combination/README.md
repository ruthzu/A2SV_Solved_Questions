...
**Problem:** [Kth-Smallest-Amount-With-Single-Denomination-Combination](https://leetcode.com/problems/kth-smallest-amount-with-single-denomination-combination)
...
Example 1:**Input:** coins = [3,6,9], k = 3
